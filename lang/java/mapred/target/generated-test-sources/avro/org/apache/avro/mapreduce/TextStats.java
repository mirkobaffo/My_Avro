...
public class TextStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4696080211152925571L;
  ...
  private static final BinaryMessageEncoder<TextStats> ENCODER =
      new BinaryMessageEncoder<TextStats>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<TextStats> DECODER =
      new BinaryMessageDecoder<TextStats>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<TextStats> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<TextStats> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<TextStats> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<TextStats>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this TextStats to a ByteBuffer.
  ...
  /**
   * Deserializes a TextStats from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a TextStats instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static TextStats fromByteBuffer(
   ...
   * @return A new TextStats RecordBuilder
   */
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<TextStats>
    WRITER$ = (org.apache.avro.io.DatumWriter<TextStats>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<TextStats>
    READER$ = (org.apache.avro.io.DatumReader<TextStats>)MODEL$.createDatumReader(SCHEMA$);
